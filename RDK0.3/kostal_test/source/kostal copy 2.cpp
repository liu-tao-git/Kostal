...
int sendRobotPlan(auto robot,auto robotStates, std::string planName, std::string fileName, std::string filePath)
{
    ...
    g_euler_Out = Quaternion_to_Euler(data_stack_rev.top()[16],data_stack_rev.top()[17],data_stack_rev.top()[18],data_stack_rev.top()[19]);
...
int main(int argc, char* argv[])
{
    ...
    int success_flag = sendRobotPlan(robot, robotStates, planName, fileName ,filePath);
