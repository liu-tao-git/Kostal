...
void periodicTask(flexiv::Robot* robot, flexiv::RobotStates* robotStates,flexiv::Log* log)
{
    ...
    try {
        while (true) {
            ...
            std::cout << g_printData.raw_sensor_data[0] 
                      << g_printData.raw_sensor_data[1]
                      << g_printData.raw_sensor_data[2]
                      << g_printData.raw_sensor_data[3]
                      << g_printData.raw_sensor_data[4]
                      << g_printData.raw_sensor_data[5]
            << std::endl;
        }
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        std::thread lowPriorityThread(std::bind(periodicTask, &robot, &robotStates, &log));
